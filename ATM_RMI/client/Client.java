	...
	*/	
		...
		if (i == 0)
		{
			...
			try {
				...
				System.out.println(function + " " + val1);
				System.exit(1);
			}
			String line = null;
			try {
	...
	{
		int amount = getAmount(acnt);
		System.out.println("Balance for account " + acnt + ":  $" + amount);
		return amount;
	}
	...
	private static void setParameters(String[]args)
	{
		...
		{
			System.out.println(help+" "+args.length);
			System.exit(1);
	...
	{
		int i = 0;
		if (function.contains("inquiry") && args.length == 3)  
		{
			Client.inquiry(val1);
			i = 1;
		} 
		else if (function.equals("withdraw") && args.length == 4) 
		{
			Client.withdraw(val1, val2);
			i = 1;
		} 
		else if (function.equals("deposit") && args.length == 4) 
		{
			Client.deposit(val1, val2);
			i = 1;
		}
		else if (function.equals("transfer") && args.length == 3)
		{
